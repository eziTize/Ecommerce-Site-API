    ...
    export default {
        ...
        methods: {
            handleSearch(e) {
                ...
                if(this.search){
                    this.$router.push((nextUrl != null ? nextUrl : '/all-services?search='+this.search))
                }else{
                    this.$router.push((nextUrl != null ? nextUrl : '/all-services'))
                }
            },
            fetchData() {
                let language = this.language
                axios.post(this.apiRootUrl+'/all_services?search='+this.search+'&start_pos='+this.start_pos, {
                    language,
                }).then(response => {
